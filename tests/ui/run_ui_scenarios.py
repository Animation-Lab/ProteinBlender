...
from ui.model_morphset_steps import build_steps as model_morphset_steps
steps.extend(model_morphset_steps(globals()))
...
from ui.morph_outliner_steps import build_steps as morph_outliner_steps
steps.extend(morph_outliner_steps(globals()))
